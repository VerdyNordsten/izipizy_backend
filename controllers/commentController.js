  ...
  getCommentsByRecipe: async (req, res) => {
    try {
      ...
      const sortedComments =
        sortBy === "asc" ? formattedComments.sort((a, b) => new Date(a.created_at) - new Date(b.created_at)) : formattedComments.sort((a, b) => new Date(b.created_at) - new Date(a.created_at))
